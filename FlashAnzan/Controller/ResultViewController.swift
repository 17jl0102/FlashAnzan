...
class ResultViewController: UIViewController {
    ...
    var quesitonResultInt = FlashAnzanManager.share.questionList.reduce(0){$0 + $1}
    ...
    override func viewDidLoad() {
        ...
        for quesiton in FlashAnzanManager.share.questionList {
            questionLabel.text! += "\(quesiton)\n"
        }
    }
    
    @IBAction func DidTapPlayAgainButton(_ sender: UIButton) {
        FlashAnzanManager.share.questionList = []
